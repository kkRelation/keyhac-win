...
- `extensions/`: Domain folders for user-defined extension scripts.
...
- Letter-sequence bindings such as `f-n`, `g-c-p`, and `g-p-p` are managed by `extensions/input/powerkey_ext.py`.
