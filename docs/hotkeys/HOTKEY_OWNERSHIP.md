...
## Extracted AHK Runtime-Owned

| Shortcut group | Behavior | Source |
| --- | --- | --- |
| `Ctrl+Alt+R` | Reload `KeyhacAhk.ahk` in-process through AHK `Reload()` | `../ahk-keyhac/KeyhacAhk.ahk` |
| `Ctrl+Shift+Alt+R` | Restart `KeyhacAhk.ahk` through `run-ahk-keyhac-hidden.vbs` | `../ahk-keyhac/KeyhacAhk.ahk` |
